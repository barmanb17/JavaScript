...
const grouped = groupBy(nums, x => (x % 2 === 0 ? 'even' : 'odd'));
console.log(grouped); // { odd: [1,3,5,7], even: [2,4,6] }
...
console.log(byAge);
// { '22': [ {name:'Alice', age:22}, {name:'Carol', age:22} ], '25': [ {name:'Bob', age:25} ] }
